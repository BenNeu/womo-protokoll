...
<p style="text-align:center;margin-bottom:4mm;">Vertragsnummer: <strong>${fmt(data.contract_number)}</strong> | Datum: <strong>${signatureDate}</strong></p>
...
<p style="margin-top:8mm;">Würzburg, den ${signatureDate}</p>
