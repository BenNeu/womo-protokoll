...
<table>
  ...
  ${data.discount_amount && parseFloat(data.discount_amount) > 0 ? `<tr><td style="color:green;">Rabattcode (${data.discount_code})</td><td style="color:green;">-${fmtPrice(data.discount_amount)} EUR</td></tr>` : ''}
